<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="ContactUs.aspx.cs" Inherits="Parking_Systeme_Project.ContactUs" %>
...
<section class="w3l-contact-info-main" id="contact">
            ...
            <div class="d-grid contact-view">
                <div class="cont-details">
                    ...
                    <div class="cont-top margin-up">
                        ...
                        <div class="cont-right">
                            <h6>Email Us</h6>
                            <p class="para"><a href="mailto:xceller@gmail.com" class="mail">xceller@gmail.com</a></p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        <div class="cont-left text-center">
                        ...
                        <div class="cont-right">
                            <h6>Address</h6>
                            <p class="para"> Xceller, #32841 block,
                               <br> #221DRS 75 IT-Park Road,<br> GreatPlace Building, Nagpur.</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="map-iframe mt-5">
        <iframe <%--src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d317718.69319292053!2d-0.3817765050863085!3d51.528307984912544!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47d8a00baf21de75%3A0x52963a5addd52a99!2sLondon%2C+UK!5e0!3m2!1sen!2spl!4v1562654563739!5m2!1sen!2spl"--%> src="assets/images/parking-lot-design-java.png" width="100%" height="300" frameborder="0" style="border: 0px; pointer-events: none;" allowfullscreen=""></iframe>
    </div>
    </div></div>
</section>
	  ...
	  <div class="container py-lg-4">
		<div class="row footer-top-29">
		  <div class="col-lg-3 col-md-6 col-sm-8 footer-list-29 footer-1">
			...
			<ul>
			  <li>
				<span class="fa fa-map-marker"></span> <p>Xceller, #32841 block,<br>#221DRS 75 IT-Park Road , GreatPlace Building,

  
					Nagpur.</p>
			  </li>
			  <li><span class="fa fa-phone"></span><a href="tel:+7-800-999-800"> +(21)-255-999-8888</a></li>
			  <li><span class="fa fa-envelope-open-o"></span><a href="mailto:xceller@gmail.com" class="mail">
				  xceller@gmail.com</a></li>
			</ul>
		  </div>
		  ...
		  <div class="col-lg-3 col-md-6 col-sm-5 footer-list-29 footer-3">
			  ...
			  <div class="footer-post mb-3">
				<a href="blog-single.html">Parking area</a>
				<p class="small"><span class="fa fa-clock-o"></span> March 9, 2020</p>
			  </div>
			  <div class="footer-post">
				<a href="blog-single.html">Parallel Parking
					and Horizontal</a>
				<p class="small"><span class="fa fa-clock-o"></span> March 9, 2020</p>
			  </div>
  ...
  <section class="w3l-footer-29-main w3l-copyright">
	<div class="container">
	  <div class="row bottom-copies">
		<p class="col-lg-8 copy-footer-29">© 2020      Smart Parking. All rights reserved | Designed by <a href="https://w3layouts.com">W3layouts</a></p>
